...
window.RTCMultiConnection = function(roomid, forceOptions) {
    ...
    function SocketConnection(connection, connectCallback) {
        ...
        connection.socket.on('return-userlist',function(responseCode,data){
            ...
            this.userlist.add(data.getItem[i].userid);
            console.log(this.userlist);
            console.log('.......');
           }
        });
        connection.getUserList=function(){
            return this.userlist;
        }

        connection.socket.on('join our room',function(roomName){
            connection.open(roomName, function() {
    ...
    (function(connection) {
        ...
        connection.notify=function(remoteUserId){
            if(connection.socket)
            {
                connection.socket.emit('notify-remoteId',remoteUserId)
            }
        }
